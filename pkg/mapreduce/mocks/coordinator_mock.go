...
// MapTasksRescheduler mocks base method.
func (m *MockCoordinator) MapTasksRescheduler() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "MapTasksRescheduler")
}

// MapTasksRescheduler indicates an expected call of MapTasksRescheduler.
func (mr *MockCoordinatorMockRecorder) MapTasksRescheduler() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MapTasksRescheduler", reflect.TypeOf((*MockCoordinator)(nil).MapTasksRescheduler))
}

// ReduceTasksRescheduler mocks base method.
func (m *MockCoordinator) ReduceTasksRescheduler() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReduceTasksRescheduler")
}

// ReduceTasksRescheduler indicates an expected call of ReduceTasksRescheduler.
func (mr *MockCoordinatorMockRecorder) ReduceTasksRescheduler() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReduceTasksRescheduler", reflect.TypeOf((*MockCoordinator)(nil).ReduceTasksRescheduler))
}
